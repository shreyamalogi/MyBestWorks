...
| **No.** | **Project Name**                          | **Tech Stack**                  | **Description**               | **GitHub Stars** | **GitHub Forks** |
|---------|-------------------------------------------|---------------------------------|-------------------------------|------------------|------------------|
...
| 14      | [Real-time ISS Tracker](https://github.com/shreyamalogi/iss-tracker) | Python, Tkinter | 🌐 Tracks the real-time position of the International Space Station (ISS) | [![GitHub stars](https://img.shields.io/github/stars/shreyamalogi/iss-tracker.svg?style=social)](https://github.com/shreyamalogi/iss-tracker/stargazers) | [![GitHub forks](https://img.shields.io/github/forks/shreyamalogi/iss-tracker.svg?style=social)](https://github.com/shreyamalogi/iss-tracker/network) |
...
| 19      | [Responsive Side Panel](https://github.com/shreyamalogi/responsive-side-panel) | HTML, CSS, JavaScript | 🖥️ A responsive side panel for websites | - | - |
